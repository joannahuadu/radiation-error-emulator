...
int main(int argc, char** argv)
{
    ...
    if (argc == 11 && std::string(argv[1]) == "-d") {
        ...
        std::cerr << "./resnet50_inference_error_dq -d [.engine] [images_cfg.txt] [labels_dir.txt] [bitflip] [bitidx] [device] [lineidx] [time] [dq]// deserialize plan file and run inference" << std::endl;
        return -1;
    }
